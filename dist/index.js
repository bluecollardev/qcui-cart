...
function useUnmount(fn) {
    React.useEffect(function () { return fn; }, EMPTY_ARRAY$1);
}
...
function useObserver(fn, baseComponentName, options) {
    ...
    var reaction$$1 = React.useRef(null);
    ...
    React.useDebugValue(reaction$$1, printDebugValue);
    useUnmount(function () {
        dispose();
    });
